...
tk.Button(root, text="Connect to Database", command=connect_db).pack(fill=tk.X)
tk.Button(root, text="Add File", command=add_file_ui).pack(fill=tk.X)
tk.Button(root, text="Create Commit", command=create_commit_ui).pack(fill=tk.X)
tk.Button(root, text="Create Branch", command=create_branch_ui).pack(fill=tk.X)
tk.Button(root, text="Update Branch", command=update_branch_ui).pack(fill=tk.X)
tk.Button(root, text="Get File by Hash", command=get_file_by_hash_ui).pack(fill=tk.X)
tk.Button(root, text="Get Commit History", command=get_commit_history_ui).pack(fill=tk.X)
tk.Button(root, text="Get Branch Info", command=get_branch_info_ui).pack(fill=tk.X)
